...
export default {
  ...
  methods: {
    ...
    handleCopyIcon(icon, event) {
      //const copyText = `<svg-icon icon-class="https://cdn.jsdelivr.net/gh/chuzhixin/zx-remixicon@master/src/icons/svg/${this.queryIcon[index]}.svg" />`;
      const copyText = `<svg-icon icon-class="${icon}" />`;
