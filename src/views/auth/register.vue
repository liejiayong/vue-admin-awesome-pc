<template>
	<div class="register-container">
		<el-alert v-if="nodeEnv !== 'development'" title="beautiful boys and girls欢迎加入vue-admin-beautifulQQ群：972435319" type="success" :closable="false"> </el-alert>
		<el-row>
...
export default {
	...
	methods: {
		...
		handleReister() {
			...
			// 	if (valid) {
			// 		const param = { userName: this.form.userName, phone: this.form.phone, password: this.form.password, phoneCode: this.form.phoneCode }
