		...
		<div class="jy-main">
			<el-row>
				...
				<el-col :xl="14" :lg="13" :md="16" :sm="20" :xs="16">
					<el-menu :background-color="variables['menu-background']" :text-color="variables['menu-color']" :active-text-color="variables['menu-color-active']" :default-active="activeMenu" mode="horizontal" menu-trigger="hover">
						<template v-for="route in routes">
							<side-bar-item v-if="!route.hidden" :key="route.path" :base-path="route.path" :item="route"></side-bar-item>
						</template>
					</el-menu>
				</el-col>
...
import { Avatar, ErrorLog, FullScreenBar, Logo, ThemeBar } from '@/layouts/components'
