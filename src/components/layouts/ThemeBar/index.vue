				...
				<div class="el-drawer__body">
					<el-form ref="form" :model="theme">
						...
						<el-form-item label="菜单背景色">
							<el-color-picker v-model="theme.menuBackground" :predefine="['#2a58ad', '#001529', '#f56c6c', '#0fd59d', '#3fb884', '#ff7a47', '#a80505']" show-alpha></el-color-picker>
						</el-form-item>
						<el-form-item label="菜单选中色">
							<el-color-picker v-model="theme.menuBackgroundActive" :predefine="['#22468a', '#1890ff', '#21e6af', '#f57e6c']" show-alpha></el-color-picker>
						</el-form-item>
						...
						<el-form-item label="标签主题色">
							<el-color-picker v-model="theme.tagBackgroundActive" :predefine="['#1890ff', '#0fd59d', '#f56c6c']" show-alpha></el-color-picker>
						</el-form-item>
						<el-form-item label="默认按钮主题色">
							<el-color-picker v-model="theme.buttonBackground" :predefine="['#1890ff', '#0fd59d', '#f56c6c']" show-alpha></el-color-picker>
						</el-form-item>
						<el-form-item label="分页选中色">
							<el-color-picker v-model="theme.paginationBackgroundActive" :predefine="['#1890ff', '#0fd59d', '#f56c6c']" show-alpha></el-color-picker>
						</el-form-item>
						<el-form-item>
...
export default {
	...
	methods: {
		...
		handleSetTheme() {
			let { layout, header, tagsBar, menuBackground, menuBackgroundActive, menuColor, tagBackgroundActive, buttonBackground, paginationBackgroundActive } = this.theme
